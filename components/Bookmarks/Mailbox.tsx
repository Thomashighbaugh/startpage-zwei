...
<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"  className="svg bi bi-mailbox hover:text-gray-400  w-16 h-16 text-white fill-current p-1 " viewBox="0 0 16 16">
  <path
